...
- 상태: stable
- 최종 수정일: 2026-06-23
- 버전: v0.10.2-beta (chapter 1+2+3+4 done, v0.9.1 chapter 5 done, v0.9.2 chapter 6 done, v0.9.3 chapter 7 done, v0.9.4 chapter 8 done, v0.9.5 chapter 9 done, v0.9.6 chapter 10 done, v0.10.0 chapter 11 done, v0.10.1 chapter 12 done, v0.10.2 chapter 13 done; package: standard-ai-workflow 0.10.2, runtime __version__ = v0.10.2-beta, tag v0.10.2-beta released 2026-06-24)
...
**누적 (v0.8.0 → v0.10.2)**: 16 + 10 release (v0.9.0 chapter 1+2+3+4 + v0.9.1 chapter 5 + v0.9.2 chapter 6 + v0.9.3 chapter 7 + v0.9.4 chapter 8 + v0.9.5 chapter 9 + v0.9.6 chapter 10 + v0.10.0 chapter 11 + v0.10.1 chapter 12 + v0.10.2 chapter 13), mypy strict cumulative **19 file clean** (mypy 2.1.0 stricter checking, full strict 도달 v1.0.0 milestone), smoke test **162/162 PASS** (cumulative, v0.8.15+ 유지, 신규 56 test 별도 subset: v0.9.0 6 + v0.9.1 4 + v0.9.2 8 + v0.9.3 4 + v0.9.4 3 + v0.9.5 6 + v0.9.6 6 + v0.10.0 6 + v0.10.1 6 + v0.10.2 9), spec §9 acceptance **12/12** (R-A follow-up part 1+2+3 ✅ + deprecation 1st+2nd cycle 종료 ✅ v0.10.0 = 6 release 분할 cycle 종료), **SemVer major** (v0.10.0: deprecation 1st+2nd cycle 동시 종료, consumer 명시적 except mandatory) + **SemVer minor** (v0.10.1: delivery layer 확장 1차, --entry-mode skill-only + claude-code 1차 PoC) + **SemVer minor** (v0.10.2: claude-code 진입점 정정 + 3 adapter + session-start self-bootstrap). Phase 11 close + Phase 12 kickoff + 4/6 → **6/6 완료** (purpose.md concept 흡수 1차 적용 + deprecation 2nd cycle 1차 적용 + R-A follow-up 1+2+3 적용 + deprecation 1st+2nd cycle 종료 = 6 release 분할 cycle) + delivery layer 확장 v0.10.1/0.10.2.
...
- github release: [https://github.com/ykylee/standard_ai_workflow/releases/tag/v0.10.2-beta](https://github.com/ykylee/standard_ai_workflow/releases/tag/v0.10.2-beta) (latest)
