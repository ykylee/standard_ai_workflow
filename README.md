...
- 상태: stable
- 최종 수정일: 2026-06-23
- 버전: v0.9.4-beta (chapter 1+2+3+4 done, v0.9.1 chapter 5 done, v0.9.2 chapter 6 done, v0.9.3 chapter 7 done, v0.9.4 chapter 8 done; package: standard-ai-workflow 0.9.4, runtime __version__ = v0.9.4-beta, tag v0.9.4-beta released 2026-06-23)
...
**누적 (v0.8.0 → v0.9.4)**: 16 + 5 release (v0.9.0 chapter 1+2+3+4 + v0.9.1 chapter 5 + v0.9.2 chapter 6 + v0.9.3 chapter 7 + v0.9.4 chapter 8), mypy strict cumulative **19 file clean** (mypy 2.1.0 stricter checking, full strict 도달 v1.0.0 milestone), smoke test **162/162 PASS** (cumulative, v0.8.15+ 유지, 신규 25 test 별도 subset: v0.9.0 6 + v0.9.1 4 + v0.9.2 8 + v0.9.3 4 + v0.9.4 3), spec §9 acceptance **11/12** (R-A follow-up part 1 ✅ v0.9.4 / part 2 v0.9.5 / part 3 v0.9.6 후속), breaking change 없음 (SemVer 2-year guarantee, v0.8.0 → 2.0.0 까지). Phase 11 close + Phase 12 kickoff (workflow_kit_roadmap.md §1 갱신, 3/6 완료 + purpose.md concept 흡수 1차 적용 + deprecation 2nd cycle 1차 적용 + R-A follow-up part 1 적용).
...
- github release: [https://github.com/ykylee/standard_ai_workflow/releases/tag/v0.9.4-beta](https://github.com/ykylee/standard_ai_workflow/releases/tag/v0.9.4-beta) (latest)
