...
- 상태: stable
- 최종 수정일: 2026-06-18
- 버전: v0.9.0-beta (chapter 1+2+3+4 done; package: standard-ai-workflow 0.9.1, runtime __version__ = v0.9.1-beta, tag v0.9.0-beta released 2026-06-18)
