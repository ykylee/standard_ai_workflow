...
- **GitHub/Gitea/GitLab**: `gh` CLI나 API를 사용하여 태그 생성 및 `dist/harnesses/*/vX.Y.Z/*.zip` 에셋을 업로드한다.
  ```bash
  # GitHub 예시
  gh release create vX.Y.Z-beta dist/harnesses/*/vX.Y.Z/*.zip --notes-file release_notes.md
  ```
