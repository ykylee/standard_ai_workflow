...
- generated_at: `2026-07-17T15:07:54Z`
...
- [0] TASK-2026-07-17-014 — v0.15.14 — **docs(install): INSTALLATION_AND_USAGE.md cross-check smoke + stale text 정정 — v0.15.0 …
- [1] TASK-2026-07-17-013 — v0.15.13 — **feat(harness): Harness apply_guide.md content cross-check smoke — 10 harness apply_gu…
- [2] TASK-2026-07-17-012 — v0.15.12 — **docs(readme): README.md cross-check smoke + stale text 정정 — v0.15.0 release 의 README …
- [3] TASK-2026-07-17-011 — v0.15.11 — **fix(release): sample tool_version housekeeping + 3-way cross-check smoke — v0.15.0 re…
- [4] TASK-2026-07-17-010 — v0.15.10 — **docs(adr): MICROSOFT_MEMORA_EVALUATION.md close-out — Memora-inspired metadata layer …
- [5] TASK-2026-07-17-009 — v0.15.9 — **SemVer patch, Harness verification smoke — 10 harness cross-check discipline anchor**.…
- [6] TASK-2026-07-17-008 — v0.15.8 — **SemVer patch, Panel 1+2 maturity_distribution cross-validation smoke — v1.0.0 진입 평가의 c…
- [7] TASK-2026-07-17-007 — v0.15.7 — **SemVer patch, Panel 3 memory_index cross-validation smoke — Phase 13 AC2 retrieval cro…
- [8] TASK-2026-07-17-006 — v0.15.6 — **SemVer patch, Panel 6/8 telemetry cross-validation smoke — Phase 15 cross-check discip…
- [9] TASK-2026-07-17-005 — v0.15.5 — **SemVer patch, Panel 4 cross-validation smoke — v0.15.x follow-up 의 cross-check discipl…
