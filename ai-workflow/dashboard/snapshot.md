...
- [0] TASK-2026-07-17-004 — v0.15.4 — **SemVer patch, ADR-007 close-out — 3rd deprecation cycle accepted no-op**. ADR-007 plac…
- [1] TASK-2026-07-17-003 — v0.15.3 — **SemVer patch, v0.14.6 out-of-scope 2 해소 — release_error 시에만 maturity refresh**. maturi…
- [2] TASK-2026-07-17-002 — v0.15.2 — **SemVer patch, v0.14.6 out-of-scope 1 해소 — legacy_memory strict opt-out 정렬**. maturity_…
- [3] TASK-2026-07-17-001 — v0.15.1 — **SemVer patch, dashboard 정합 + Panel 4 SMOKE_COUNT_PATTERN 확장**. v0.15.0 ⚠️ BREAKING pus…
- [4] TASK-2026-07-16-001 — v0.15.0 — **⚠️ SemVer minor, BREAKING — 2nd deprecation cycle 종결 (work_backlog.md.bak drop) + push…
- [5] TASK-2026-07-01-003 — v0.11.18 — **🎯 SemVer patch, FULL mypy strict 도달 공식 봉인 (107 file clean)**. 누적 mypy strict 잔여 23 → …
- [6] TASK-2026-07-02-001 — v0.11.21 — **SemVer patch, 3차 batch robust-patcher stable 승격**. v0.11.20 (2차 batch 4 skill stable)…
- [7] TASK-2026-07-09-001 — v0.13.3 — **SemVer patch, Phase 13 AC4+ (self-documenting wiki ↔ memory bidirectional link) close-…
- [8] TASK-2026-07-09-002 — v0.13.2 — **SemVer patch, Phase 13 AC3 (self-recovering) close-out**. drift prevention 의 6 case 가 …
- [9] TASK-2026-07-09-003 — v0.13.1 — **SemVer patch, Phase 13 AC2 (memory_index 활용도) close-out**. v0.13.0 Quality Dashboard 의…
