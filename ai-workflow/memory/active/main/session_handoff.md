...
상주하며 좁은 선언을 red 로 잡는다 (분류 현황: 국소 7 / 전역 3 / 미분류 265 —
미분류 개수가 관찰 지표다). push 게이트 전량 2축은 불변.
