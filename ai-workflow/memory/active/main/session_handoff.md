...
- 상태: active
- 최종 수정일: 2026-09-25 (89차 세션 **종료** — CI 폐지 뒷정리 + push 를 게이트 통과 기록에 묶음 + 무력하던 force 차단 hook 수리)
...
- 그 이전 기준선은 [`baselines.md`](./baselines.md) 에 있다 (이관 102건, 최신이 위).
