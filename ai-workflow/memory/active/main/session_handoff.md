...
상주하며 좁은 선언을 red 로 잡는다 (분류 현황: **국소 79 / 전역 3 / 미분류 194**
— 66차 보급 1차 이후. 미분류 개수가 관찰 지표다). 보급 절차는 스펙 §2.1 —
