...
마스터 HTML 발표 덱(`docs/presentations/ai-agent-onboarding.html`, 38장) 제작, 4단계 검증(`verify_deck.py` PASS), 30/60/90분 트랙 전환, 구술 노트, 레이아웃 밀도 보강, 사람용/AI용 문서 독자 분리 및 38장 슬라이드 간 수직 고정 정렬 픽스 전량 완료. `main` 브랜치 커밋 및 푸시 완료.
