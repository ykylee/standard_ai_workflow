...
- 상태: active
- 최종 수정일: 2026-09-23 (86차 세션 **종료** — task 5건 close. 판정이 아무것도 재지 않는데 숫자는 멀쩡한 결함족: 승격 후보 어휘겹침→선언 / index 락으로 터지던 case / 요약 case 수 대조 축 신설 / 검색이 자기가 집은 것을 안 돌려줌 + 고친 질의가 또 상수 / memory_index 승격 4건)
