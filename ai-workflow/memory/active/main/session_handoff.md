...
- 상태: active
- 최종 수정일: 2026-09-23 (87차 세션 **종료** — v1.11.0 환경 배포 정리 + 중첩 worktree 호스트 의존 red 수리 + 워크플로우 평가 → 이슈 10건 등록 · M-013(세션 컨텍스트 예산) · M-014(CI 처리량) 개설)
...
- 그 이전 기준선은 [`baselines.md`](./baselines.md) 에 있다 (이관 100건, 최신이 위).
