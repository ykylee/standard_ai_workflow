...
- 상태: active
- 최종 수정일: 2026-09-23 (86차 세션 **종료** — task 7건 close. 두 결함족: **판정이 아무것도 재지 않는데 숫자는 멀쩡하다** (승격 후보 상수 / 요약 case 수 / 검색이 집은 것을 안 돌려줌 / 고친 질의가 또 상수) + **범위가 좁은데 '대상이 없다' 로 보인다** (하루 네 번; 마지막엔 미측정 사유 자체가 범위의 그림자였다))
