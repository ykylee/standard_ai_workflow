...
def workflow_common_sources() -> list[Path]:
    return [
        REPO_ROOT / "ai-workflow" / "core" / "global_workflow_standard.md",
        REPO_ROOT / "ai-workflow" / "core" / "workflow_adoption_entrypoints.md",
        REPO_ROOT / "ai-workflow" / "core" / "workflow_skill_catalog.md",
        REPO_ROOT / "ai-workflow" / "core" / "existing_project_onboarding_contract.md",
        REPO_ROOT / "ai-workflow" / "core" / "workflow_harness_distribution.md",
        REPO_ROOT / "ai-workflow" / "core" / "workflow_release_spec.md",
        REPO_ROOT / "ai-workflow" / "core" / "strategic_threads.md",
        REPO_ROOT / "ai-workflow" / "core" / "maturity_matrix.json",
        REPO_ROOT / "ai-workflow" / "core" / "automated_repro_scaffold_skill_spec.md",
        REPO_ROOT / "ai-workflow" / "memory" / "phase5_governance_guide.md",
        REPO_ROOT / "ai-workflow" / "examples" / "end_to_end_skill_demo.md",
        REPO_ROOT / "ai-workflow" / "mcp" / "read_only_bundle.md",
        REPO_ROOT / "ai-workflow" / "schemas" / "read_only_harness_mcp_examples.json",
        REPO_ROOT / "ai-workflow" / "schemas" / "read_only_jsonrpc_fixtures.json",
        REPO_ROOT / "ai-workflow" / "schemas" / "read_only_transport_descriptors.json",
        REPO_ROOT / "ai-workflow" / "templates" / "release_note_template.md",
        REPO_ROOT / "ai-workflow" / "templates" / "pilot_candidate_checklist.md",
        REPO_ROOT / "ai-workflow" / "templates" / "pilot_adoption_record_template.md",
        REPO_ROOT / "ai-workflow" / "harnesses" / "README.md",
    ]


def minimal_core_sources() -> list[Path]:
    return [REPO_ROOT / "ai-workflow" / "core" / name for name in MINIMAL_CORE_DOCS]


def global_snippet_source_map() -> dict[str, list[Path]]:
    return {
        "codex": [
            REPO_ROOT / "ai-workflow" / "global-snippets" / "codex" / "README.md",
            REPO_ROOT / "ai-workflow" / "global-snippets" / "codex" / "config.toml.snippet",
        ],
        "opencode": [
            REPO_ROOT / "ai-workflow" / "global-snippets" / "opencode" / "README.md",
            REPO_ROOT / "ai-workflow" / "global-snippets" / "opencode" / "opencode.global.jsonc",
        ],
    }


def harness_specific_sources(harness: str) -> list[Path]:
    harness_dir = REPO_ROOT / "ai-workflow" / "harnesses" / harness
...
def bootstrap_export_sources(harness: str, temp_repo: Path) -> list[Path]:
    args = [
        "python3",
        str(REPO_ROOT / "ai-workflow" / "scripts" / "bootstrap_workflow_kit.py"),
        "--target-root",
        str(temp_repo),
        "--project-slug",
        "export_sample",
    ...
    *,
    ...
    if include_global_snippets:
        for source in global_snippet_source_map().get(harness, []):
            destination = bundle_root / "global-snippets" / rel(source, REPO_ROOT / "ai-workflow" / "global-snippets")
            copy_file(source, destination)
