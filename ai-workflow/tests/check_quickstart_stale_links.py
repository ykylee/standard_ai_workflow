...
SCRIPT_PATH = REPO_ROOT / "ai-workflow" / "mcp" / "check-quickstart-stale-links" / "scripts" / "run_check_quickstart_stale_links.py"
...
def main() -> int:
    completed = subprocess.run(
        [
            ...
            str(SCRIPT_PATH),
            "--quickstart-path",
            str(REPO_ROOT / "ai-workflow" / "examples" / "bootstrap_output_samples.md"),
            "--project-profile-path",
            str(REPO_ROOT / "ai-workflow" / "templates" / "project_workflow_profile_template.md"),
            "--session-handoff-path",
            str(REPO_ROOT / "ai-workflow" / "examples" / "README.md"),
        ],
        cwd=REPO_ROOT,
        capture_output=True,
        text=True,
