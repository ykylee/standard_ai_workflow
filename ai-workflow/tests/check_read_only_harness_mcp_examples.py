...
SCRIPT_PATH = REPO_ROOT / "ai-workflow" / "scripts" / "generate_read_only_harness_mcp_examples.py"
EXAMPLES_PATH = REPO_ROOT / "ai-workflow" / "schemas" / "read_only_harness_mcp_examples.json"
