...
SCRIPT_PATH = REPO_ROOT / "ai-workflow" / "scripts" / "generate_read_only_jsonrpc_fixtures.py"
FIXTURE_PATH = REPO_ROOT / "ai-workflow" / "schemas" / "read_only_jsonrpc_fixtures.json"
...
def main() -> int:
    ...
    if checked_in["fixtures"][9]["request"]["params"]["arguments"]["work_backlog_index_path"] != "ai-workflow/examples/acme_delivery_platform/work_backlog.md":
    ...
    if latest_backlog_path != "ai-workflow/examples/acme_delivery_platform/backlog/2026-04-18.md":
