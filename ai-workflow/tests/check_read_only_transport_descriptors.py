...
SCRIPT_PATH = REPO_ROOT / "ai-workflow" / "scripts" / "generate_read_only_transport_descriptors.py"
DESCRIPTOR_PATH = REPO_ROOT / "ai-workflow" / "schemas" / "read_only_transport_descriptors.json"
