...
def test_relative_paths_in_state():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        cmd = [
            sys.executable, "ai-workflow/scripts/generate_workflow_state.py",
            "--project-profile-path", "docs/PROJECT_PROFILE.md",
            "--session-handoff-path", "ai-workflow/memory/codex/phase6/session_handoff.md",
            "--work-backlog-index-path", "ai-workflow/memory/work_backlog.md",
            "--latest-backlog-path", "ai-workflow/memory/codex/phase6/backlog/2026-05-01.md",
            "--repository-assessment-path", "ai-workflow/memory/repository_assessment.md",
