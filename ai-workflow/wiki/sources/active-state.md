...
> L1 SSOT: `ai-workflow/memory/active/main/state.json` (439 lines)
...
| `session.current_focus` | TASK-2026-08-20-main-007 v1.3.0 릴리스 — 101 커밋 누적분 발행 + breaking 표기 판단 기준 문서화 |
