...
- **Wiki rule**: [concepts/okf-open-knowledge-format.md](../ai-workflow/wiki/concepts/okf-open-knowledge-format.md)
...
- [SCHEMA.md §5.1 R1-R9](../ai-workflow/wiki/SCHEMA.md): 본 가이드 의 모든 page 는 R-1~R-9 의 standard format 준수.
...
- [concepts/okf-open-knowledge-format.md](../ai-workflow/wiki/concepts/okf-open-knowledge-format.md) — OKF rule definition
- [decisions/adr-006-okf-compat-frontmatter.md](../ai-workflow/wiki/decisions/adr-006-okf-compat-frontmatter.md)
- [decisions/adr-007-okf-consumer-mode.md](../ai-workflow/wiki/decisions/adr-007-okf-consumer-mode.md)
- [decisions/adr-008-in-repo-path-to-url.md](../ai-workflow/wiki/decisions/adr-008-in-repo-path-to-url.md)
- [decisions/adr-011-okf-version-auto-detect.md](../ai-workflow/wiki/decisions/adr-011-okf-version-auto-detect.md)
- [decisions/adr-018-v-r12-commit-pinned-url.md](../ai-workflow/wiki/decisions/adr-018-v-r12-commit-pinned-url.md)
- [decisions/adr-019-v-r13-semantic-url-verification.md](../ai-workflow/wiki/decisions/adr-019-v-r13-semantic-url-verification.md)
- [concepts/v-r10-url-validity-lint.md](../ai-workflow/wiki/concepts/v-r10-url-validity-lint.md)
- [concepts/v-r11-body-audit.md](../ai-workflow/wiki/concepts/v-r11-body-audit.md)
- [concepts/v-r13-semantic-url-verification.md](../ai-workflow/wiki/concepts/v-r13-semantic-url-verification.md)
- [OKF spec (primary source)](https://github.com/GoogleCloudPlatform/knowledge-catalog/blob/main/okf/SPEC.md)
- [Sample bundle](./samples/okf-bundle-2026-06-16/) — generated by our `okf_export`
