...
- `README.md`
- 운영 문서 위치:
- `ai-workflow/memory/<branch_name>/`
- 백로그 위치:
- `ai-workflow/memory/<branch_name>/backlog/tasks/`
- 세션 인계 문서 위치:
- `ai-workflow/memory/<branch_name>/session_handoff.md`
- 환경 기록 위치:
- `ai-workflow/memory/repository_assessment.md`
- 공유 지식 문서 위치:
- `docs/` (Architecture, Dev, Analysis, Planning)
...
- `docs/` 아래의 공유 지식 문서는 생성/수정 시 PR 리뷰를 통한 승인(Peer Review)을 필수로 한다. (자세한 규칙은 `docs/README.md` 참조)
- 환경 제약:
