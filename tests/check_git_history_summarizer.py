...
def test_git_history_summarizer():
    ...
    cmd_md = ["python3", "mcp/git-history-summarizer/scripts/run_git_history_summarizer.py", "--range", "HEAD"]
    ...
    # Test JSON format
    cmd_json = ["python3", "mcp/git-history-summarizer/scripts/run_git_history_summarizer.py", "--range", "HEAD", "--format", "json"]
