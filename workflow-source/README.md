...
- [ai-workflow/memory/codex/phase6/state.json](../ai-workflow/memory/codex/phase6/state.json)
- [ai-workflow/memory/codex/phase6/session_handoff.md](../ai-workflow/memory/codex/phase6/session_handoff.md)
- [ai-workflow/memory/work_backlog.md](../ai-workflow/memory/work_backlog.md)
- [ai-workflow/memory/codex/phase6/backlog/2026-04-30.md](../ai-workflow/memory/codex/phase6/backlog/2026-04-30.md)
- [ai-workflow/memory/repository_assessment.md](../ai-workflow/memory/repository_assessment.md)
...
5. 이후 표준 skill/MCP 도입 범위는 `workflow-source/core/` 문서를 기준으로 결정한다.
...
- 빠른 상태 요약: [../ai-workflow/memory/codex/phase6/state.json](../ai-workflow/memory/codex/phase6/state.json)
- 세션 인계 문서: [../ai-workflow/memory/codex/phase6/session_handoff.md](../ai-workflow/memory/codex/phase6/session_handoff.md)
- 작업 백로그 인덱스: [../ai-workflow/memory/work_backlog.md](../ai-workflow/memory/work_backlog.md)
