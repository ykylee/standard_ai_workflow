...
- 상태: final
- 최종 수정일: 2026-06-09
- 관련 문서: `../../ai-workflow/memory/active/state.json`, `core/workflow_kit_roadmap.md`
...
python3 workflow_kit/server/read_only_entrypoint.py --tool assess_milestone_progress \
  --payload-json '{"matrix_path": "core/maturity_matrix.json", "backlog_path": "ai-workflow/memory/active/backlog/2026-04-27.md"}'
```
