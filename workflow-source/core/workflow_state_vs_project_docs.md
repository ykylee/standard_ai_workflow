...
- 문서 목적: `ai-workflow/memory/active/*` 와 실제 프로젝트 문서(`docs/...`)의 역할 차이를 한 번에 이해할 수 있게 정리한다.
...
- 작업 상태 기록, handoff, 세션 기준선, state cache 는 `ai-workflow/memory/active/*` 에 쓴다.
...
- `ai-workflow/memory/active/backlog/*.md` 는 workflow state backlog 다.
