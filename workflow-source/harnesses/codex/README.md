...
- Codex 전역 MCP 설정으로 바로 복사하기 전에 [../../mcp_servers/read_only_bundle.md](../../mcp_servers/read_only_bundle.md) 의 draft 범위와 `apply_mode` 를 먼저 확인한다.
...
- `ai-workflow/memory/active/` 경로가 현재 저장소 구조와 맞는지 확인
