...
- 상태: prototype
- 최종 수정일: 2026-04-27
- 관련 문서: `../../ai-workflow/memory/active/session_handoff.md`, `../../core/workflow_mcp_candidate_catalog.md`
...
```bash
python3 workflow-source/mcp_servers/git-history-summarizer/scripts/run_git_history_summarizer.py --range "HEAD~5..HEAD"
```
