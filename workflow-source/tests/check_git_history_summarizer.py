...
def test_git_history_summarizer():
    ...
    cmd_md = ["python3", "workflow-source/mcp/git-history-summarizer/scripts/run_git_history_summarizer.py", "--range", "HEAD~1..HEAD"]
    ...
    # Test JSON format
    cmd_json = ["python3", "workflow-source/mcp/git-history-summarizer/scripts/run_git_history_summarizer.py", "--range", "HEAD~1..HEAD", "--format", "json"]
