...
1. 하한의 출처가 `requires-python` **선언**이다 (해석기 매트릭스가 아니다).
...
(구 case 6 "CI 셀이 하한 해석기를 깐다" 는 2026-09-23 CI workflow 폐지
(TASK-2026-09-23-main-022)로 smoke.yml 이 사라져 삭제했다. 하한 해석기를 구해
재는 일은 case 2 가 이 호스트에서 직접 한다 — 못 구하면 미측정으로 보고한다.)
"""
