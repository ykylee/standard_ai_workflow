...
2. test_version_override_pyproject: --version=0.7.5 일 때 tag=v0.7.5-beta + notes_file=Beta-v0.7.5.md (dist staging 가정)
3. test_version_default_pyproject: --version 미지정 시 version_source=pyproject.toml (default)
"""
...
def test_version_default_pyproject() -> None:
    ...
    # default version 은 pyproject 의 0.7.11 (현재 HEAD)
    assert out["tag"] == "v0.7.11-beta", f"expected v0.7.11-beta, got {out.get('tag')}"
