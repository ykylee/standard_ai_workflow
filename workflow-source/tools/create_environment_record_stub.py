"""deprecated shim — 구현은 :mod:`workflow_kit.tools.create_environment_record_stub` 로 이동 (v1.1.8).
...
import workflow_kit.tools.create_environment_record_stub as _impl
