"""deprecated shim — 구현은 :mod:`workflow_kit.tools.fill_reverse_engineering_artifacts` 로 이동 (v1.1.8).
...
import workflow_kit.tools.fill_reverse_engineering_artifacts as _impl
