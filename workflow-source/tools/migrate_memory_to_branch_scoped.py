"""deprecated shim — 구현은 :mod:`workflow_kit.tools.migrate_memory_to_branch_scoped` 로 이동 (v1.1.8).
...
import workflow_kit.tools.migrate_memory_to_branch_scoped as _impl
